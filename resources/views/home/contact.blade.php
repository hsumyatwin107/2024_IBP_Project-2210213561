...
<section class="py-lg-5">
    ...
    <div style="margin-left: 43%">
        ...
        <div>
            <input type="email" name="email" placeholder="please write your email">
        </div>
        <div>
            <input type="number" name="phone" placeholder="please write your phone number">
        </div>
        <div>
